    ...
    describe('Position Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'orderbook/api/positions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Position', () => {
                service.create(new Position(null)).subscribe(received => {
            ...
            it('should update a Position', () => {
                service.update(new Position(123)).subscribe(received => {
